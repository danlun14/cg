...
int main(/*int argc, char *argv[]*/)
{
    ...
    P = basic::simpleSafeNumber(10000);
    std::cout << "P - " << P << std::endl;
    if (P == 5)
    {
        P = 47;
    ...
    while (x >= P)
    {
        x = basic::simpleSafeNumber(10000);
    }
    long long g = 0;

    long long y = 0;
    std::cout << "x - " << x << std::endl;
    cipher::init::elgamal(P, x, g, y);
    m = rand() % (P - 1) + 1;
    ...
    long long P1 = basic::simpleSafeNumber(10000);
    long long Q1 = basic::simpleSafeNumber(10000);
